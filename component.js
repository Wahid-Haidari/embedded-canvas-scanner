...
class CanvasMenu extends HTMLElement {
	constructor(){
		super();
	}
  ...
  connectedCallback(){
  	this.innerHTML = `
       <div id="canvas_menu" class="container">
          <a href="https://canvas.ou.edu/" class="logomark">
            <img src="https://du11hjcvx0uqb.cloudfront.net/dist/images/canvas_logomark_only@2x-e197434829.png" width="70px" height="70px">
          </a>   
        ...
        <svg xmlns="http://www.w3.org/2000/svg" 
          class="ic-icon-svg ic-icon-svg--inbox" version="1.1" x="0" y="0" 
          viewBox="0 0 280 280" 
...
customElements.define('canvas-menu' , CanvasMenu);
...
customElements.define('canvas_menu' , CanvasMenu);
